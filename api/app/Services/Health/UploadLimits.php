 ...
 * that recordings above some unstated size vanish. No framework changes this --
 * PHP has already thrown the body away before Laravel boots. Three numbers on the
 * healthcheck turn it into something you can see before it happens.
 */
final class UploadLimits
{
    ...
    /**
     * ini_parse_quantity handles the shorthand notation ("16M") that ini_get returns
     * verbatim.
     *
     ...
     * misconfiguration. -1 fails every comparison above instead.
     */
